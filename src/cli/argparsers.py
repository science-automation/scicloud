...
exec_parser = scivm_subparsers.add_parser('exec', description='Executes a program on Science VM through the shell. This is the shell version of cloud.call',
...
mapexec_parser = scivm_subparsers.add_parser('mapexec', description='Executes many programs in parallel on Science VM through the shell. This is the shell version of cloud.map. \
...
files_syncfromcloud_parser.add_argument('name', default=None, help='Name of file stored on Science VM')
files_syncfromcloud_parser.add_argument('destination', type=shell_path_post_op, help='Local path to save file to')

files_synctocloud_parser = files_subparsers.add_parser('sync-to-cloud', help='Upload file only if it does not exist on Science VM or has changed')
files_synctocloud_parser.add_argument('source', default=None, help='local path to file')
files_synctocloud_parser.add_argument('name', default=None, help='Name for file to be stored on Science VM')
...
bucket_synctocloud_parser.add_argument('obj_path', metavar='obj-path', default=None, help='Name for bucket object to be stored on Science VM')
...
volume_sync_parser = volume_subparsers.add_parser('sync', help='Sync local directory to volume on Science VM', description='Syncs a local path and a cloud volume.', formatter_class=argparse.RawDescriptionHelpFormatter,)
